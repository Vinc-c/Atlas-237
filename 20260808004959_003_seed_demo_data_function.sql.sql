...
-- Function to seed demo data for a new organization
...
BEGIN
  ...
  VALUES
    (new_org_id, gen_random_uuid(), 'Finance Master', 'send_email', 'Send invoice #INV-2024-001 to TechFlow Solutions ($150,000)', 'medium', 'pending'),
    (new_org_id, gen_random_uuid(), 'Sales Master', 'create_quote', 'Create quote for InnovateLabs setup ($45,000)', 'low', 'pending');
